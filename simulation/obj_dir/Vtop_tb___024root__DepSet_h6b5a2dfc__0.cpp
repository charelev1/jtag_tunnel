...
VL_INLINE_OPT void Vtop_tb___024root___nba_sequent__TOP__0(Vtop_tb___024root* vlSelf) {
    ...
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.top_tb__DOT__top_i__DOT__clk_out = ((1U 
                                                   & (~ (IData)(vlSelfRef.top_tb__DOT__rst))) 
                                                  && (1U 
                                                      & (~ (IData)(vlSelfRef.top_tb__DOT__top_i__DOT__clk_out))));
}
...
VL_INLINE_OPT void Vtop_tb___024root___nba_sequent__TOP__1(Vtop_tb___024root* vlSelf) {
    ...
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.top_tb__DOT__top_i__DOT__data_3 = ((1U 
                                                  & (~ (IData)(vlSelfRef.top_tb__DOT__rst))) 
                                                 && (IData)(vlSelfRef.top_tb__DOT__top_i__DOT__data_2));
}
...
VL_INLINE_OPT void Vtop_tb___024root___nba_sequent__TOP__2(Vtop_tb___024root* vlSelf) {
    ...
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.top_tb__DOT__top_i__DOT__data_2 = ((1U 
                                                  & (~ (IData)(vlSelfRef.top_tb__DOT__rst))) 
                                                 && (IData)(vlSelfRef.top_tb__DOT__top_i__DOT__data_1));
    vlSelfRef.top_tb__DOT__top_i__DOT__data_1 = ((1U 
                                                  & (~ (IData)(vlSelfRef.top_tb__DOT__rst))) 
                                                 && (IData)(vlSelfRef.top_tb__DOT__top_i__DOT__data_0));
}
...
VL_INLINE_OPT void Vtop_tb___024root___nba_sequent__TOP__3(Vtop_tb___024root* vlSelf) {
    ...
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.top_tb__DOT__top_i__DOT__data_0 = ((1U 
                                                  & (~ (IData)(vlSelfRef.top_tb__DOT__rst))) 
                                                 && (IData)(vlSelfRef.top_tb__DOT__data));
}
...
#endif
            VL_FATAL_MT("clk_gen/top_tb.sv", 4, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("clk_gen/top_tb.sv", 4, "", "Active region did not converge.");
            }
