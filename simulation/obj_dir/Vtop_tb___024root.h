...
class alignas(VL_CACHE_LINE_BYTES) Vtop_tb___024root final : public VerilatedModule {
  public:
    ...
    CData/*0:0*/ top_tb__DOT__top_i__DOT__clk_out;
    CData/*0:0*/ top_tb__DOT__rst;
    CData/*0:0*/ top_tb__DOT__data;
    CData/*0:0*/ top_tb__DOT__top_i__DOT__data_0;
    CData/*0:0*/ top_tb__DOT__top_i__DOT__data_1;
    CData/*0:0*/ top_tb__DOT__top_i__DOT__data_2;
    CData/*0:0*/ top_tb__DOT__top_i__DOT__data_3;
    CData/*0:0*/ __Vtrigprevexpr___TOP__top_tb__DOT__clk__0;
    CData/*0:0*/ __Vtrigprevexpr___TOP__top_tb__DOT__top_i__DOT__clk_out__0;
