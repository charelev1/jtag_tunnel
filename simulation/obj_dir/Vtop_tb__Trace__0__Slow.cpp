...
VL_ATTR_COLD void Vtop_tb___024root__trace_init_sub__TOP__0(Vtop_tb___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+3,0,"data",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBus(c+9,0,"period",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->pushPrefix("top_i", VerilatedTracePrefixType::SCOPE_MODULE);
    ...
    tracep->declBit(c+5,0,"data_out",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+6,0,"data_0",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+5,0,"data_1",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+7,0,"data_2",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+8,0,"data_3",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->popPrefix();
    tracep->popPrefix();
}
...
VL_ATTR_COLD void Vtop_tb___024root__trace_full_0_sub_0(Vtop_tb___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+2,(vlSelfRef.top_tb__DOT__rst));
    bufp->fullBit(oldp+3,(vlSelfRef.top_tb__DOT__data));
    bufp->fullBit(oldp+4,(vlSelfRef.top_tb__DOT__top_i__DOT__clk_out));
    bufp->fullBit(oldp+5,(vlSelfRef.top_tb__DOT__top_i__DOT__data_1));
    bufp->fullBit(oldp+6,(vlSelfRef.top_tb__DOT__top_i__DOT__data_0));
    bufp->fullBit(oldp+7,(vlSelfRef.top_tb__DOT__top_i__DOT__data_2));
    bufp->fullBit(oldp+8,(vlSelfRef.top_tb__DOT__top_i__DOT__data_3));
}
